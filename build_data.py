...
tf.flags.DEFINE_string('X_input_dir', 'data/monet2photo/trainA',
                       'X input directory, default: data/ukiyoe2photo/trainA')
tf.flags.DEFINE_string('Y_input_dir', 'data/monet2photo/trainB',
                       'Y input directory, default: data/ukiyoe2photo/trainB')
tf.flags.DEFINE_string('X_output_file', 'data/tfrecords/monet.tfrecords',
                       'X output tfrecords file, default: data/tfrecords/monet.tfrecords')
